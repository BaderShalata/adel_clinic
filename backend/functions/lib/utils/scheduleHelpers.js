...
exports.generateDrYosefSchedule = generateDrYosefSchedule;
exports.generateDrAliAbidSchedule = generateDrAliAbidSchedule;
exports.generateDrAdelShalataSchedule = generateDrAdelShalataSchedule;
 ...
 */
function generateDrYosefSchedule() {
    const schedule = [];
 ...
 */
function generateDrAliAbidSchedule() {
    const schedule = [];
    // Sunday, Monday, Tuesday: 5 PM - 8 PM (15 min slots)
 ...
 */
function generateDrAdelShalataSchedule() {
    const schedule = [];
    // Sunday, Monday, Wednesday, Thursday: 5 PM - 8 PM (10 min slots)
 ...
 */
function generateTimeSlots(scheduleEntry) {
    const slots = [];
...
//# sourceMappingURL=scheduleHelpers.js.map