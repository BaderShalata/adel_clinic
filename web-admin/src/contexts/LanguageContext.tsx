...
const translations: Translations = {
  ...
  doctors: { en: 'Crew', ar: 'الطاقم', he: 'הצוות' },
  ...
  clinicOpen: { en: 'Clinic is Open', ar: 'العيادة مفتوحة', he: 'המרפאה פתוחה' },
  clinicLocked: { en: 'Clinic is Locked', ar: 'العيادة مغلقة', he: 'המרפאה נעולה' },
  lockClinic: { en: 'Lock Clinic', ar: 'قفل العيادة', he: 'נעל מרפאה' },
  unlockClinic: { en: 'Unlock Clinic', ar: 'فتح العيادة', he: 'פתח מרפאה' },
  lockClinicConfirm: { en: 'Are you sure you want to lock the clinic? Patients will not be able to use the app.', ar: 'هل أنت متأكد أنك تريد قفل العيادة؟ لن يتمكن المرضى من استخدام التطبيق.', he: 'האם אתה בטוח שברצונך לנעול את המרפאה? מטופלים לא יוכלו להשתמש באפליקציה.' },
  unlockClinicConfirm: { en: 'Are you sure you want to unlock the clinic? Patients will be able to use the app again.', ar: 'هل أنت متأكد أنك تريد فتح العيادة؟ سيتمكن المرضى من استخدام التطبيق مرة أخرى.', he: 'האם אתה בטוח שברצונך לפתוח את המרפאה? מטופלים יוכלו להשתמש באפליקציה שוב.' },
  ...
  // Doctors
  addDoctor: { en: 'Add Member', ar: 'إضافة عضو', he: 'הוסף חבר צוות' },
  ...
  newBadge: { en: 'New', ar: 'جديد', he: 'חדש' },
  newAppointmentRequest: { en: 'New Appointment Request', ar: 'طلب موعد جديد', he: 'בקשת תור חדשה' },
  ...
  // Doctors Page
  manageDoctors: { en: 'Manage crew members and schedules', ar: 'إدارة أعضاء الطاقم والجداول', he: 'ניהול חברי צוות ולוחות זמנים' },
  searchDoctorsPlaceholder: { en: 'Search crew by name or specialty...', ar: 'البحث عن أعضاء الطاقم بالاسم أو التخصص...', he: 'חיפוש חברי צוות לפי שם או התמחות...' },
  foundDoctors: { en: 'Found {count} member(s) matching "{query}"', ar: 'تم العثور على {count} عضو مطابق لـ "{query}"', he: 'נמצאו {count} חברי צוות התואמים ל"{query}"' },
  noMatchingDoctors: { en: 'No crew members match your filters', ar: 'لا يوجد أعضاء مطابقين للفلاتر', he: 'לא נמצאו חברי צוות התואמים לסינון' },
  noDoctorsYet: { en: 'No crew members yet', ar: 'لا يوجد أعضاء بعد', he: 'אין חברי צוות עדיין' },
  addFirstDoctor: { en: 'Add your first crew member to get started', ar: 'أضف أول عضو في الطاقم للبدء', he: 'הוסף את חבר הצוות הראשון שלך כדי להתחיל' },
  editDoctor: { en: 'Edit Member', ar: 'تعديل بيانات العضو', he: 'עריכת חבר צוות' },
  addNewDoctor: { en: 'Add New Member', ar: 'إضافة عضو جديد', he: 'הוספת חבר צוות חדש' },
  updateDoctor: { en: 'Update Member', ar: 'تحديث العضو', he: 'עדכון חבר צוות' },
  noSchedule: { en: 'No schedule', ar: 'لا يوجد جدول', he: 'אין לוח זמנים' },
  doctorPhoto: { en: 'Member Photo', ar: 'صورة العضو', he: 'תמונת חבר צוות' },
  ...
  allRoles: { en: 'All Roles', ar: 'جميع الأدوار', he: 'כל התפקידים' },
