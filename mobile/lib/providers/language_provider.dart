...
class LanguageProvider extends ChangeNotifier {
  ...
  static const Map<String, Map<String, String>> _translations = {
    ...
    'clinicLocked': {'en': 'Clinic is Closed', 'ar': 'العيادة مغلقة', 'he': 'המרפאה סגורה'},
    'clinicLockedMessage': {'en': 'The clinic is currently closed. Please try again later.', 'ar': 'العيادة مغلقة حالياً. يرجى المحاولة مرة أخرى لاحقاً.', 'he': 'המרפאה סגורה כרגע. אנא נסה שוב מאוחר יותר.'},
    'clinicStillLocked': {'en': 'The clinic is still closed.', 'ar': 'العيادة لا تزال مغلقة.', 'he': 'המרפאה עדיין סגורה.'},
    'tryAgain': {'en': 'Try Again', 'ar': 'حاول مرة أخرى', 'he': 'נסה שוב'},
    'accountExists': {'en': 'Account Already Exists', 'ar': 'الحساب موجود بالفعل', 'he': 'החשבון כבר קיים'},
    'resetPassword': {'en': 'Reset Password', 'ar': 'إعادة تعيين كلمة المرور', 'he': 'איפוס סיסמה'},
    'resetPasswordDescription': {'en': 'Enter your email to receive a password reset link.', 'ar': 'أدخل بريدك الإلكتروني لتلقي رابط إعادة تعيين كلمة المرور.', 'he': 'הזן את האימייל שלך כדי לקבל קישור לאיפוס סיסמה.'},
    'resetPasswordEmailSent': {'en': 'Password reset email sent! Check your spam/junk folder if you don\'t see it.', 'ar': 'تم إرسال بريد إعادة التعيين! تحقق من مجلد البريد العشوائي إذا لم تجده.', 'he': 'אימייל לאיפוס סיסמה נשלח! בדוק בתיקיית הספאם אם לא מצאת אותו.'},
    'resetPasswordFailed': {'en': 'Failed to send reset email. Please try again.', 'ar': 'فشل في إرسال بريد إعادة التعيين. حاول مرة أخرى.', 'he': 'שליחת אימייל האיפוס נכשלה. נסה שוב.'},
    'sendResetLink': {'en': 'Send Reset Link', 'ar': 'إرسال رابط إعادة التعيين', 'he': 'שלח קישור איפוס'},
    ...
    'invalidCredential': {'en': 'Account not found or incorrect password.', 'ar': 'الحساب غير موجود أو كلمة المرور غير صحيحة.', 'he': 'החשבון לא נמצא או שהסיסמה שגויה.'},
